...
editor_cmd = editor --default was: terminal .. " -e " .. editor
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control"}, "F7", function() awful.spawn("systemctl hibernate") end,
              {description = "Hibernate", group = "general"}),
