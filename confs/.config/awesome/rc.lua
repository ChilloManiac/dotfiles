...
beautiful.init("/home/cnor/.config/awesome/theme.lua")

-- This is used later as the default terminal and editor to run.
local terminal = "/home/cnor/.local/bin/kitty"
local editor = os.getenv("EDITOR") or "nvim"
local editor_cmd = editor --default was: terminal .. " -e " .. editor
...
awful.screen.connect_for_each_screen(function(s)
  ...
  s.myclock = awful.widget.textclock('%H:%M, %a %b %d')

  s.spacer = wibox.widget {
...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey, "Shift" }, "s",
    function() awful.spawn("scrot -s '/tmp/%F_%T_$wx$h.png' -e 'xclip -selection clipboard -target image/png -i $f'") end,
    { description = "Take a screenshot", group = "launcher" }),
  awful.key({ modkey }, "F7", function() awful.spawn("xset s activate") end,
    { description = "Lock", group = "general" })
)
